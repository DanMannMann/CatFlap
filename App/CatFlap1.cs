...
namespace App
{
    public class CatFlap1 : Modeler<DomainModel.northwindEntities>
    {
		public CatFlap1()
            : base(() => new DomainModel.northwindEntities())
        {
            Categories = CreateAccessor<DomainModel.Category>();CustomerDemographics = CreateAccessor<DomainModel.CustomerDemographic>();Customers = CreateAccessor<DomainModel.Customer>();Employees = CreateAccessor<DomainModel.Employee>();Order_Details = CreateAccessor<DomainModel.Order_Detail>();Orders = CreateAccessor<DomainModel.Order>();Products = CreateAccessor<DomainModel.Product>();Regions = CreateAccessor<DomainModel.Region>();Shippers = CreateAccessor<DomainModel.Shipper>();Suppliers = CreateAccessor<DomainModel.Supplier>();Territories = CreateAccessor<DomainModel.Territory>();
        }
...
public SetAccessor<DomainModel.northwindEntities, DomainModel.Order_Detail> Order_Details {{ get; private set; }}
